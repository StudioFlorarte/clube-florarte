...
export default function ProfileForm({ email, userId, profile, details, subscription }: any) {
 ...
 return <div className="profile-settings"><header className="settings-heading"><p className="script">Clube Florarte</p><h1>{t('profile')}</h1><p>{t('profileIntro')}</p></header>
